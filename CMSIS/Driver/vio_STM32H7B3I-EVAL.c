/******************************************************************************
 * @file     vio_STM32H7B3I-EVAL.c
 * @brief    Virtual I/O implementation for board STM32H7B3I-EVAL
 * @version  V1.0.0
...
/*! \page vio_STM32H7B3I-EVAL Physical I/O Mapping

The table below lists the physical I/O mapping of this CMSIS-Driver VIO implementation.

Virtual Resource  | Variable       | Physical Resource on STM32H7B3I-EVAL      |
:-----------------|:---------------|:------------------------------------------|
vioBUTTON0        | vioSignalIn.0  | PC13: Button TAMPER & KEY                 |
vioLED0           | vioSignalOut.0 | PG13: LD1 (GREEN)                         |
*/
...
//  signal,     pin,                   pull resistor,      active state
  { vioLED0,    GPIO_PIN_ID_PORTG(13), ARM_GPIO_PULL_NONE, VIO_ACTIVE_LOW }
};
#endif
