...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(WIFI_SPI4_NSS_GPIO_Port, WIFI_SPI4_NSS_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : WIFI_SPI4_NSS_Pin */
  ...
  /*Configure GPIO pin : INT_MFX_IRQ_OUT_Pin */
  GPIO_InitStruct.Pin = INT_MFX_IRQ_OUT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(INT_MFX_IRQ_OUT_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : INT_USB_OTG_FS_OVRCR_Pin */
  GPIO_InitStruct.Pin = INT_USB_OTG_FS_OVRCR_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(INT_USB_OTG_FS_OVRCR_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : INT_uSDCard_Detect1_Pin */
  GPIO_InitStruct.Pin = INT_uSDCard_Detect1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(INT_uSDCard_Detect1_GPIO_Port, &GPIO_InitStruct);
